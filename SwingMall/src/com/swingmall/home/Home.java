...
public class Home extends Page {
	JPanel p_content;// 상품 리스트를 담게 될 패널, 추후 상세보기로 전환 시 이 패널 자체를 들어낼거임
	ArrayList<ProductItem> itemList;// 생성된 상품 아이템들을 담게 될 리스트(왜?productItem클래스내에서 아벤트를 구현하면 너무 많은 정보를 넘겨야 하고, 페이지도
									// 아님->효율성 저하)
